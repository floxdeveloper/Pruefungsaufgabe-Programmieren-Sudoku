...
public class sudokuController {
	...
	private void handleSolve() {
		...
		if (result.get() == ButtonType.OK) {
			...
			//Wenn nicht nach Sudoku Regeln -> würde hier altes anzeigen (kommt nie vor da nach jeder Eingabe gecheckt wird)
			sudokuAuslesen();
			
			//Bei unlösbaren Sudokus stoppt Backtracking ohne ein gefülltes Sudoku zurück zu lassen -> kann danach abgefragt werden obs geklappt hat
